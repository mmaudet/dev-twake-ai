...
const CreateExcalidrawItem = ({ displayedFolder, isReadOnly, onClick }) => {
  ...
  const handleClick = async () => {
    ...
    const url = generateWebLink({
      ...
      pathname: '',
      hash: `/bridge/excalidraw/new/${_displayedFolder._id}`
    })
...
export default CreateExcalidrawItem
